...
CA_ADVANCING_PRE = 95.3
CA_RECEDING_PRE = 75.5
CA_ADVANCING_POST = 53.7
CA_RECEDING_POST = 41.4
...
if __name__ == "__main__":
    ...
    pipeline_dir = os.path.join("/scratch/sbszkudlarek/TUD_LBM_results",
