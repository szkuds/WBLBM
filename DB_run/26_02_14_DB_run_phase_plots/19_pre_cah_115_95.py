...
def run_chem_step_pre_cah_115_95(pipeline_timestamp, wetting_results_dir):
    ...
    # Move the simulation results to pipeline structure
    return move_results_to_pipeline(sim, pipeline_timestamp, "run_chem_step_pre_cah_115_95")
...
if __name__ == "__main__":
    ...
    chem_dir = run_chem_step_pre_cah_115_95(pipeline_timestamp, wetting_dir)
