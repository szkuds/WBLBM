...
from wblbm.operators.force.gravitational_force_multiphase_WithModifiedMask import \
    GravityForceMultiphaseDropletWithModifiedMask
from wblbm.run import Run
from wblbm.operators.force import GravityForceMultiphaseBubble
from wblbm import visualise, GravityForceMultiphaseDroplet
import jax
...
def rising_bubble_mrt():
    ...
    gravity = GravityForceMultiphaseDropletWithModifiedMask(
